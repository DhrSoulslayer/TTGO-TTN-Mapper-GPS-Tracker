...
//#define USE_OTAA
    ...
    static const u1_t PROGMEM NWKSKEY[16] = { 0x2E, 0xF9, 0xAC, 0x0B, 0x51, 0xF7, 0x76, 0x42, 0x7E, 0x1B, 0x62, 0x27, 0x83, 0xF8, 0x57, 0xD2 };
    // LoRaWAN AppSKey, application session key MSB
    static const u1_t PROGMEM APPSKEY[16] = { 0x1D, 0xDA, 0x6A, 0x22, 0xF7, 0x22, 0x88, 0x22, 0xD7, 0xBF, 0x3D, 0xDA, 0x37, 0x89, 0x2B, 0x72 };
    // LoRaWAN end-device address (DevAddr)
    // This has to be unique for every node MSB
    static const u4_t DEVADDR = 0x260BD8EE;
