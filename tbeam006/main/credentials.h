...
//#define USE_OTAA
    ...
    static const u1_t PROGMEM NWKSKEY[16] = {  0x62, 0x93, x59, 0x39, 0x63, 0x37, 0x68, 0xE8, 0x24, 0xEA };
    // LoRaWAN AppSKey, application session key MSB
    static const u1_t PROGMEM APPSKEY[16] = { 0x06, , 0xDC, 0x07, 0x19, 0xE2, 0xCB, 0x28, 0x45 };
